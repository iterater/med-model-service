kb_list = {
    ...
    'AH_TREATMENT_ARB.PKL': ['AH', 'RECOMMENDATION'],
    'AH_TREATMENT_BB.PKL': ['AH', 'RECOMMENDATION'],
    'AH_TREATMENT_CACB.PKL': ['AH', 'RECOMMENDATION'],
    'AH_TREATMENT_D.PKL': ['AH', 'RECOMMENDATION'],
    'AH_TREATMENT_IACE.PKL': ['AH', 'RECOMMENDATION']
}
